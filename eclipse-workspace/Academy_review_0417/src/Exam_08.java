...
class Exam_08 {
	public static void main(String[] args) {
		...
		샤오미Tv2 a샤오미Tv = new 샤오미Tv2();
		삼성Tv2 a삼성Tv = new 삼성Tv2();
		LGTv2 aLGTv = new LGTv2();
		...
		LGTv2 aLGTv2 = (LGTv2) a표준Tv;
		aLGTv2.게임모드전환();
	}
}

class 샤오미Tv2 extends 표준Tv {
	void 켜기() {
